    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <div className="mb-4 sm:mb-6">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Medical Documents Management</h1>
          <p className="text-sm sm:text-base text-gray-600 px-2">Manage medical document submissions, verifications, and certificate issuance</p>
        </div>
