        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
          ...
          {!certificatesLoading && medicalDocumentStatus && (
            <div className="mb-6 sm:mb-8">
              <div className={`border rounded-xl p-4 sm:p-6 shadow-lg ${medicalDocumentStatus.status === 'issued' ? 'bg-gradient-to-r from-green-50 to-blue-50 border-green-200' :
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
                  <div className="flex items-center">
                    <div className={`flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full mr-3 sm:mr-4 flex-shrink-0 ${medicalDocumentStatus.status === 'issued' ? 'bg-green-100' :
                    ...
                    <div>
                      <h2 className={`text-lg sm:text-xl md:text-2xl font-bold ${medicalDocumentStatus.status === 'issued' ? 'text-green-800' :
                      ...
                      <p className={`text-sm sm:text-base font-medium ${medicalDocumentStatus.status === 'issued' ? 'text-green-700' :
                  ...
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${medicalDocumentStatus.status === 'issued' ? 'bg-green-100 text-green-800' :
