...
import { UserIcon, DocumentTextIcon, ClipboardDocumentListIcon, CalendarIcon, PhoneIcon, MapPinIcon, HeartIcon } from '@heroicons/react/outline';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Manage your personal information and view your health records
            </p>
          </div>
            ...
            <div className="p-6">
              ...
              {activeTab === 'personal' && (
                <div className="space-y-6">
                  ...
                  {/* Patient Profile Information Section */}
                  {!patientProfile ? (
                    <div className="text-center py-12 bg-white border border-gray-200 rounded-lg">
                      <UserIcon className="mx-auto h-12 w-12 text-gray-400" />
                      <h3 className="mt-2 text-sm font-medium text-gray-900">No patient profile found</h3>
                      <p className="mt-1 text-sm text-gray-500">
                        You need to create your patient profile to access health services.
                      </p>
                      <div className="mt-6">
                        <button
                          onClick={() => router.push('/patient/profile')}
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 mb-4">Patient Profile Information</h3>
                          ...
                          <dl className="space-y-3">
                            <div>
                              ...
                              <dd className="text-sm text-gray-900">
                                {patientProfile.name || 'Please update your profile'}
                              </dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Gender</dt>
                              <dd className="text-sm text-gray-900">
                                {patientProfile.gender === 'Other' ? 'Not specified' : patientProfile.gender}
                              </dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Age</dt>
                              <dd className="text-sm text-gray-900">
                                {(patientProfile.age && patientProfile.age > 0) ? patientProfile.age : 'Not set'}
                              </dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Date of Birth</dt>
                              <dd className="text-sm text-gray-900">
                                {patientProfile.date_of_birth ? formatDate(patientProfile.date_of_birth) : 'Not set'}
                              </dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Blood Type</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.blood_type || 'Not set'}</dd>
                            </div>
                          </dl>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6">
                          ...
                          <dl className="space-y-3">
                            <div>
                              ...
                              <dd className="text-sm text-gray-900">{patientProfile.email || user?.email}</dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Contact Number</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.contact_number || 'Not set'}</dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Address</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.address || 'Not set'}</dd>
                            </div>
                          </dl>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6">
                          ...
                          <dl className="space-y-3">
                            <div>
                              ...
                              <dd className="text-sm text-gray-900">
                                {patientProfile.emergency_contact_first_name || patientProfile.emergency_contact_surname 
                                  ? `${patientProfile.emergency_contact_first_name || ''} ${patientProfile.emergency_contact_surname || ''}`.trim()
                                  : 'Not set'
                                }
                              </dd>
                            </div>
                            <div>
                              ...
                              <dd className="text-sm text-gray-900">{patientProfile.emergency_contact_relationship || 'Not set'}</dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Contact Number</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.emergency_contact_number || 'Not set'}</dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Address</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.emergency_contact_address || 'Not set'}</dd>
                            </div>
                          </dl>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6">
                          ...
                          <dl className="space-y-3">
                            <div>
                              ...
                              <dd className="text-sm text-gray-900">{patientProfile.religion || 'Not set'}</dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Nationality</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.nationality || 'Not set'}</dd>
                            </div>
                            <div>
                              <dt className="text-sm font-medium text-gray-500">Civil Status</dt>
                              <dd className="text-sm text-gray-900">{patientProfile.civil_status || 'Not set'}</dd>
                            </div>
                          </dl>
                        </div>
                      </div>
