...
SEED_USERS = [
    ...
    {
        "label": "Kindergarten Student",
        "email": "kinder@wmsu.test",
        ...
        "is_superuser": False,
        "first_name": "Kevin",
        "last_name": "Kindergarten",
    },
    {
        "label": "Elementary Student",
        "email": "elementary@wmsu.test",
        "password": "WmsuStudent123!",
        "user_type": "student",
        ...
        "is_superuser": False,
        "first_name": "Elly",
        "last_name": "Elementary",
    },
    {
        "label": "High School Student",
        "email": "highschool@wmsu.test",
        "password": "WmsuStudent123!",
        "user_type": "student",
    ...
    {
        "label": "Senior High Student",
        "email": "seniorhigh@wmsu.test",
        "password": "WmsuStudent123!",
        "user_type": "student",
        "grade_level": "Senior High School",
        "is_staff": False,
        "is_superuser": False,
        "first_name": "Sarah",
        "last_name": "SeniorHigh",
    },
    {
        "label": "College Student",
        "email": "college@wmsu.test",
        "password": "WmsuStudent123!",
        "user_type": "student",
        "grade_level": "College",
        "is_staff": False,
    ...
    {
        "label": "Employee Patient",
        "email": "employee@wmsu.test",
        "password": "WmsuStudent123!",
        "user_type": "student",
        "grade_level": "Employee",
        "is_staff": False,
        "is_superuser": False,
        "first_name": "Emily",
        "last_name": "Employee",
    ...
    def _ensure_seed_users(self, reset_users):
        ...
        for entry in SEED_USERS:
            ...
            if created or reset_users:
                ...
                user.grade_level = entry.get("grade_level", "")
